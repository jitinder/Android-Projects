...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    //private PetDbHelper helper = new PetDbHelper(this);
    Uri receivedUri;
    ...
    private void deletePet() {
        if(receivedUri != null) {
            ...
            if (deleted == 0) {
                ...
                Toast.makeText(this, R.string.deleted_pet, Toast.LENGTH_SHORT).show();
            }
            finish();
        }
    }
    ...
    private void updatePet(){
        ...
        if(receivedUri == null ||
                TextUtils.isEmpty(name) && mGender == PetEntry.GENDER_UNKNOWN){
            return;
        }
        ...
        int changed = getContentResolver().update(receivedUri, values, null, null);

        if(changed == 0){
            Toast.makeText(this, R.string.no_update, Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, R.string.updated_pet, Toast.LENGTH_SHORT).show();
        }
    }
